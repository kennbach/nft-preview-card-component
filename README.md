...
- Solution URL: [https://github.com/kennbach/nft-preview-card-component](https://github.com/kennbach/nft-preview-card-component)
- Live Site URL: [https://kennbach.github.io/nft-preview-card-component/](https://kennbach.github.io/nft-preview-card-component/)
...
The biggest challenge for me on this project was implementing the product hover overlay image. I took a lot of twists and turns before I came across a viable solution on w3schools.com. I will link to that article (How To Image Hover Overlay) below.

### Continued development

My CSS positioning skills were definitely a weakness while handling the image hover overlay. I will be looking to strengthen my knowledge here as I move forward.

### Useful resources

- [w3schools: How to image hover overlay](https://www.w3schools.com/howto/howto_css_image_overlay.asp) - This was where I finally found the CSS only solution for handling the image hover overlay.
